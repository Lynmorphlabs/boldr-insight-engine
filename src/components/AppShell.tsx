      ...
      <aside className="hidden md:flex w-[260px] flex-col border-r border-border bg-surface/70 backdrop-blur">
        <div className="px-5 pt-6 pb-5 border-b border-border">
          <Link to="/inbox" className="flex items-center gap-3 group">
            <div className="h-9 w-9 rounded-xl gradient-brand flex items-center justify-center shadow-[0_8px_24px_-8px_oklch(0.72_0.19_45_/_0.6)]">
              <img src={boldrLogo} alt="Boldr" className="h-5 w-5 object-contain" />
            </div>
